...
if __name__ == "__main__":
    ...
    parser.add_argument('-s','--stringtie', action='store_true', help='Run StringTie')
    parser.add_argument('-m','--merge', action='store_true', help='Merge transcripts')
    parser.add_argument('-a','--abundance', action='store_true', help='Count transcripts')
    parser.add_argument('-all','--all', action='store_true', help='Run all stages')
    parser.add_argument('-ass','--ass', action='store_true', help='Run only the assembly stages')
    parser.add_argument('-t','--tools', action='store_true', help='Run auxiliar tools')
